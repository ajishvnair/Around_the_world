...
<body>
	<div class="video1-w3l" data-vide-bg="video1/1">
		<!--header-->
			...
			<div class="sub-main-w3">
				...
				<form action="login123.php" method="post">
					...
					<div class="pom-agile">
						...
						<input placeholder="Password" name="Password" class="pass" type="password" style="width:160.8px; height:22px;" required="">
					</div>
					<div class="sub-w3l">
					...
					<div class="right-w3l">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Login" name="loginnew">
					</form>
					</div
					
					<div class="right-w3l">
					<form action="indexsignup.php" method="post">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="sign up" style="width:165px; height:45px;">
					</form>
					</div>
